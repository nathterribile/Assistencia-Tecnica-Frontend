async function getAll() {
    let response = await fetch("http://147.15.121.92:8080/os")
...
async function get(id) {    
    ...
    if (id == "All") {
        ...
        let response = await fetch("http://147.15.121.92:8080/os/"+id)
...
async function update(id) {
    ...
    const response = await fetch("http://147.15.121.92:8080/os/"+id, {
        method: "PUT",
        headers: {
            'Content-Type': 'application/json'
        },
