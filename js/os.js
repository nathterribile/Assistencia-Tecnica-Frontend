async function getAll() {
    let response = await fetch("http://172.29.208.1:8080/os")
...
async function get(id) {    
    ...
    if (id == "All") {
        ...
        let response = await fetch("http://172.29.208.1:8080/os/"+id)
...
async function save() {
    ...
    const response = await fetch("http://172.29.208.1:8080/os", {
        method: "POST",
        headers:{
...
async function update(id) {
    ...
    const response = await fetch("http://172.29.208.1:8080/os/"+id, {
        method: "PUT",
        headers: {
            'Content-Type': 'application/json'
        },
